...
| Command safety               | Policy tests and strict demo evals                          | Working                          | Blocked/high/medium/low risk classification is covered; strict demo evals require observed blocked-command evidence, not a hardcoded pass.                               |
